        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <form action="cms/subject/update.action" method="post" enctype="multipart/form-data" class="form-horizontal" onsubmit="return checkForm();">
                        ...
                        <div class="collapse" id="collapseExample2">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <input type="text" id="subjectTop" value="${subject.subjectTop }" name="subjectTop" class="form-control"  placeholder="标的置顶号" >
                                </div>
                            </div>
                            <br />
                            ...
                            <div class="form-group" id="moneyparent">
                                ...
                                <div class="col-md-3">
	                                <div class="input-group">
	                                    <input type="text" data-tofixed  id="money" name="subjectMoney" value="${subject.subjectMoney }" class="form-control" required placeholder="标的金额" onblur="checkMoney()" data-money-ToUpper>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="input-group">
                                        <input type="text" data-tofixed id="minmoney" value="${subject.subjectSubscriptionAmountMin }" name="SARmin" class="form-control" required placeholder="最小认购额度" data-money-ToUpper>
                                        <div class="input-group-addon">元</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="input-group">
                                        <input type="text" data-tofixed id="maxmoney" name="SARmax" value="${subject.subjectSubscriptionAmountMax }" class="form-control" required placeholder="最大认购额度" data-money-ToUpper>
                                        <div class="input-group-addon">元</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group <c:if test="${subject.subjectPaymentMethod == 2 }">none</c:if> guding">
                                ...
                                <div class="col-md-3">
                                    <div class="input-group">
                                        <input type="text"  class="form-control" onblur="this.value=this.value.replace(/[^\d]/g,'')"  onkeyup="this.value=this.value.replace(/[^\d]/g,'')" name="subjectPaymentDay" value="${subject.subjectPaymentDay }"  placeholder="还息日" >
								        	 ...
								        	 <c:forEach items="${protocolList }" var="protocol">
								        		<div class="fileli">
										        	<span class="inputfile">
					                                	<button class="btn btn-default btn-info" type="button" onclick="window.location.href='${basePath}cms/project/downloadFile.action?fileName=${protocol.protocolAddress}'">下载文件</button>
			                        					<span>${protocol.protocolName }</span>
					                                	<input type="file" name="pinstructions"	style="display:none"/>
				                                	</span>
					                                	<input type="hidden" value="${protocol.protocolId }">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
								        	<span class="inputfile">
			                                	...
			                                	<input type="file" name="pfile"	style="display:none"/><span class="stat">${purchaseAgree.purchaseAgreeName }</span><a class="btn btn-success" onclick="watchprotemp()">点击预览</a>
		                                	</span>
...
<!--                                 	</div> -->
                          ...
                          <div class="form-group">
                                ...
                                <div class="col-md-8">
						        	<span class="inputfile">
	                                	...
	                                	<input type="file" name="tempaltefile" id="tempaltefile"	style="display:none"/><span class="stat">${purchaseAgree.purchaseAgreeTemplateName }</span><a class="btn btn-success" onclick="watchtemplate()">点击预览</a>
                                	</span>
                           		</div>
                           	</div>
        ...
        if (investDiscount == 1) {
           var html = "";
            html = html + '<div class="form-group" id="discountIn">'+
                            ...
                            '<div class="col-md-4 well">'+
                                '<div class="input-group col-md-4">'+
                                    '<input type="text" id="txlv" name="subjectInvestDiscountNum" data-tofixed onblur="rule.onlyNonNegative(this)" onkeyup="rule.onlyNonNegative(this)"  class="form-control" required placeholder="优惠金额" value="'+investDiscountNum+'">'+
                                    '<div class="input-group-addon">元</div>'+
                                '</div>'+
                            '</div>'+
                        '</div>';
    ...
    function addFileNameToInput(){
        ...
        function titles(){
        	...
        	var str = "projectId="+projectId+"&subjectId="+subjectId;
        	$.ajax({
                type:"post",
                ...
                success:function(data){
                	...
                	$.each(data.protocolList, function(i, d) {
                		if(d.ischeck==1){
                        	...
                        	var html = "<input  type='checkbox' name='pPid' value='"+d.pProtocolId+"' ><span>"+d.pProtocolName+"</span><br>";
                		}
        ...
        function zdylv(){
                ...
                html = html + '<div class="form-group" id="zdy">'+
                                ...
                                '<div class="col-md-4 well">'+
                                    '<div class="input-group col-md-4">'+
                                        '<input type="text" id="txlv" name="discountRate" onblur="rule.onlyNonNegative(this)" onkeyup="rule.onlyNonNegative(this)"  data-tofixed value="${subject.subjectCustomDiscountRate*100}" class="form-control" required placeholder="贴息利率" >'+
                                        '<div class="input-group-addon">%</div>'+
                                    '</div>'+
                                '</div>'+
                            '</div>';
    ...
    function checkForm(){
        ...
        if ("" == subjectName) {
                ...
                var state=false;
                  $.ajax({
                    ...
                    dataType:"json",
                    data:{subjectName:subjectName,checktype:2,subjectId:subjectId},
                    success:function(data){
    	...
    	if("" != money){
    		if(${subject.subjectMoney}+lastMoney < money){
    			$.alert("标的金额超出剩余额度");
