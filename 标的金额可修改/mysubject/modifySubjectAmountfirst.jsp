...
<body>
            ...
            <div class="row form-horizontal" >
                <div class="col-lg-12">
                    ...
                    <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <p class="form-control-static">
                                    <span class="">${subjectAlreadyInvest}</span>
                                </p>
                            </div>
                    </div>
                    ...
                    <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <p class="form-control-static">
                                    <span class="">${subjectMoney - subjectAlreadyInvest}</span>
                                </p>
                            </div>
                    </div>
                    ...
                    <div class="formProject" style="display:none;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <p class="form-control-static">
                                    <span class="">${projectNosplitSubjectMoney}</span>
                                </p>
                            </div>
                    </div>
    ...
    <script>
        // 标的id
        var initSubjectId  = '${subjectId}'
        var initSubjectAlreadyInvest  = '${subjectAlreadyInvest}'
        var initSubjectMoney  = '${subjectMoney}'
        var initProjectNosplitSubjectMoney  = '${projectNosplitSubjectMoney}'
        
        // 返回到审核通过标的页面
        $('#returnToList').click(function(){
            window.location.href="https://houtai.hzqisheng.cn/cms/subject/list.action?state=1"
        })
                        ...
                        success: function(data) {
                            if (data.message == "success") {
                                ...
                                if (data.subjectList != null && data.subjectList.length > 0) {
                                    // 有数据
                                    window.allOtherSubject = data.subjectList
        ...
        function checkSubject(id) {
            ...
            otherSubjectHtml += '<div class="form-group"><label class="col-md-2 control-label">标的名称：</label><div class="col-md-3"><p class="form-control-static"><span class="">'+ lineData.subjectName +'</span></p></div></div>'
            ...
            otherSubjectHtml += '<div class="form-group"><label class="col-md-2 control-label">已募金额：</label><div class="col-md-3"><p class="form-control-static"><span class="">'+ lineData.subjectAlreadyInvest +'</span></p></div></div>'
