...
<body>
            ...
            <div class="row form-horizontal" >
                <div class="col-lg-12">
                    ...
                    <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <p class="form-control-static">
                                            ...
                                            <span class=""><fmt:formatNumber type="number" value="${subject.subjectMoney} " maxFractionDigits="2" minFractionDigits="2"/></span>
                                        </p>
                                    </div>
                    </div>
                    ...
                    <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <p class="form-control-static">
                                            <span class=""><fmt:formatNumber type="number" value="${subject.subjectAlreadyInvest} " maxFractionDigits="2" minFractionDigits="2"/></span>
                    ...
                    <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <p class="form-control-static">
                                                <span class=""><fmt:formatNumber type="number" value="${subject.subjectMoney - subject.subjectAlreadyInvest}" maxFractionDigits="2" minFractionDigits="2"/></span>
                    ...
                    <div class="formProject" style="display:none;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <p class="form-control-static">
                                            <span class=""><fmt:formatNumber type="number" value="${project.projectNosplitSubjectMoney} " maxFractionDigits="2" minFractionDigits="2"/></span>
                                ...
                                <div class="form-group "  >
                                    ...
                                    <div class="col-md-2">
                                        <div class="input-group">
                                            <input type="number"  class="form-control changeAmount" data-money-ToUpper required placeholder="1万元起，万元递增" value=""/>
                                ...
                                <div class="form-group" >
                                    ...
                                    <div class="col-md-2">
                                        <div class="input-group">
                                            <input type="number"  class="form-control ConfirmChangeAmount" data-money-ToUpper required placeholder="1万元起，万元递增" value=""/>
                                            <div class="input-group-addon">元</div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        ...
        // 确认修改按钮点击后弹出一个comfirm框
        function checkComfirmModify(msg,data) {
            $.confirm(msg,[{yes:'确定'},{no:'取消'}],function(type,e){
                if(type=='yes'){
                    console.log(data)
        ...
        $('.formProject .comfirmModify').click(function(){
            ...
            // console.log(data)
            // comfirmModifyAjax(data)
            var msg = "将项目余额中取"+ (amount/10000) +"万元额度添加到本标的金额"
            checkComfirmModify(msg,data)
        ...
        $('.formOtherSubject .comfirmModify').click(function(){
            ...
            if(parseInt($('#alreadyInv').text()) == 0 && parseInt(amount) == parseInt($('#leftAmount').text())) {
            ...
            // console.log(data)
            // comfirmModifyAjax(data)
            var msg = "将从"+$('#selectedSubjectName').text()+"取"+(amount/10000)+"万元额度添加到本标的金额"
            checkComfirmModify(msg,data)
        ...
        $('.reduceAmount .comfirmModify').click(function(){
            ...
            // console.log(data)
            // comfirmModifyAjax(data)  
            var msg = "本标的金额将减少"+(-amount/10000)+"万元额度同时释放到项目余额中"
            checkComfirmModify(msg,data)          
        ...
        function checkSubject(id) {
            ...
            var subMoneyTmp=lineData.subjectMoney-lineData.subjectAlreadyInvest
            otherSubjectHtml += '<input type="hidden" name="pageIndex" id="selectedSubjectId"  value="'+id+'">'  // 用于传递被取金额的项目的id
            otherSubjectHtml += '<div class="form-group"><label class="col-md-2 control-label">被取金额标的名称：</label><div class="col-md-3"><p class="form-control-static"><span class=""  id="selectedSubjectName">'+ lineData.subjectName +'</span></p></div></div>'
            otherSubjectHtml += '<div class="form-group"><label class="col-md-2 control-label">标的金额：</label><div class="col-md-3"><p class="form-control-static"><span class="">'+ lineData.subjectMoney.toFixed(2) +'</span></p></div></div>'
            otherSubjectHtml += '<div class="form-group"><label class="col-md-2 control-label">已募金额：</label><div class="col-md-3"><p class="form-control-static"><span class=""  id="alreadyInv">'+ lineData.subjectAlreadyInvest.toFixed(2) +'</span></p></div></div>'
            otherSubjectHtml += '<div class="form-group"><label class="col-md-2 control-label ">标的余额：</label><div class="col-md-3"><p class="form-control-static"><span  id="leftAmount" class="" >'+  (subMoneyTmp).toFixed(2) +'</span></p></div></div>'
