            ...
            <form action="" class="form-horizontal mainform" method="post" enctype="multipart/form-data">
                 <div style="text-align:center;">
	                 <div class="center-box btn-group">
	                      <button type="button" class="btn btn-default btn-primary" id="first">投资项目信息</button><button id="second" type="button" class="btn btn-default">用户基本信息</button>
	                 </div>
                 </div>
                        ...
                        <div class="col-md-2">
                            <select  name="channelId" class="form-control" onchange="changeChannelId()" id="selectChannelId">
                              <c:forEach items="${channelList }" var="channel">
                                <option value="${channel.channelId }"<c:if test="${channel.channelId == channelId }">selected</c:if>>${channel.channelName }</option>
                              </c:forEach>
                            </select>
                        </div>
                    </div>
                ...
                <div class="col-lg-12" style="display: none;" id="nextDiv">
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <input type="number" class="form-control" id="uPhone" placeholder="请输入用户手机号码" required="required" name="userPhone" onblur="selectUserInfo()">
                        </div>
                    </div>
                    <br />
                    ...
                    <div id="userInfo" style="display:none">
                        ...
                        <div id="hasUserCardInfo" style="display:none">
                            ...
                            <div id="noUserCardSubbranch" style="display:none"> 
                              <div class="form-group">
                                  <label class="col-md-2 control-label">用户开户支行：</label>
                                  <div class="col-md-3">
                                      <input type="text" class="form-control" id="investTransferUserCardSubbranch" placeholder="请输入用户开户支行" required="required" name="investTransferUserCardSubbranch" >
                                  </div>
                              </div>
                              <br />
                            </div>
                        ...
                        <div id="noUserCardInfo" style="display:none">
                              ...
                              <div class="form-group">
                                  <label class="col-md-2 control-label">用户银行卡名称：</label>
                                  <div class="col-md-2">
                                      <select class="form-control" name="investTransferCardBank" id="investTransferCardBank" onchange="changeBank()">
                              ...
                              <div class="form-group none" id="otherCard">
                                  <label class="col-md-2 control-label"></label>
                                  <div class="col-md-3">
                                      <input type="text" class="form-control" id="cardBank" placeholder="请输入用户银行卡名称" required="required" name="cardBank" >
                                  </div>
                              </div>
                              <br />
                              ...
                              <div class="form-group">
                                  <label class="col-md-2 control-label">用户银行卡卡号：</label>
                                  <div class="col-md-3">
                                      <input type="number" class="form-control" onKeypress="javascript:if(event.keyCode == 32)event.returnValue = false;" onpaste="return false" oncopy="return false"  id="investTransferCardCardnum" placeholder="请输入用户银行卡卡号" required="required" name="investTransferCardCardnum" >
                                  </div>
                              </div>
                              <br />
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-md-3">
                                      <input type="number" class="form-control" onKeypress="javascript:if(event.keyCode == 32)event.returnValue = false;" onpaste="return false" oncopy="return false" id="reInvestTransferCardCardnum" placeholder="请再次输入银行卡卡号" required="required" name="reInvestTransferCardCardnum" >
                                  </div>
                              </div>
                              <br />
                              ...
                              <div class="form-group">
                                  <label class="col-md-2 control-label">用户开户支行：</label>
                                  <div class="col-md-3">
                                      <input type="text" class="form-control" id="investTransferCardSubbranch" placeholder="请输入用户开户支行" required="required" name="investTransferCardSubbranch" >
                                  </div>
                              </div>
                              <br />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input type="number" class="form-control" id="investTransferLineNum" placeholder="请输入开户行行号" required="required" name="investTransferLineNum" >
                            </div>
                        </div>
                        <br />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="input-group">
                                    <input type="number" class="form-control" id="iMoney"  onpaste="return false" oncopy="return false" onblur="checkIMoney()" placeholder="请输入用户投资金额" required="required" name="investTransferInvestMoney" data-money-ToUpper>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="input-group">
                                  <input type="number" class="form-control" id="reIMoney"  onpaste="return false" oncopy="return false" onblur="checkReIMoney()" placeholder="请再次输入用户投资金额" required="required" name="reInvestTransferInvestMoney" data-money-ToUpper>
                                  <div class="input-group-addon">元</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <input class="form-control"  type="text"  name="investTransferInvestTime" required pattern="yyyy-MM-dd HH:mm:ss" id="datetime"/>
                            </div>
                        </div>
                        <br />
    ...
    <script type="text/javascript">
        ...
        function selectSubjectList(pageIndex){
          ...
          $.ajax({
                ...
                dataType:"json",
                data:{channelId:channelId,pageIndex:pageIndex},
                    ...
                    if(data.message == "success"){
                       ...
                       if(data.subjectList != null && data.subjectList.length > 0){
                          for(var i =0;i<data.subjectList.length;i++){
                            ...
                            item.innerHTML='<td>'+data.subjectList[i].subjectId+'</td><td>'+data.subjectList[i].subjectName+'</td><td>'+data.subjectList[i].strMoney+'</td><td>'+data.subjectList[i].alreadyInvest+'</td><td>'+(Number(data.subjectList[i].rate)*100).toFixed(2)+ '%' +'</td><td>'+data.subjectList[i].minmoney + '-' + data.subjectList[i].maxmoney+'</td><td>'+data.subjectList[i].subjectAdditionalMultiple+'</td><td>'+(Number(data.subjectList[i].arnum)*100).toFixed(2)+ '%' +'</td><td><div class="operation-btn" onclick="checkSubject('+data.subjectList[i].subjectId+')">选择</div></td>';
        ...
        function selectUserInfo(){
          ...
          $.ajax({
              ...
              dataType:"json",
              data:{phone:phone,channelId:channelId,subjectId:subjectId},
              success:function(data){
                  if(data.message == "success"){
                     //数据请求成功
                     $('#userInfo').show();
                     ...
                     if(data.cardType == 1){
                        ...
                        $.each(data.bankPaymentLimitList,function(i,item){
                            $('#investTransferCardBank').append('<option value="'+this.bankPaymentLimitName+'" >'+this.bankPaymentLimitName+'</option>');
                        }) 
                     }
                     var riskTypeName = '';
        ...
        function changeUserCardInfo(type){
          ...
          $.ajax({
              ...
              dataType:"json",
              data:{phone:phone,channelId:channelId},
              success:function(data){
                  if(data.message == "success"){
                     //数据请求成功
                      if(type == 0){
        ...
        $('#reInvestTransferCardCardnum').blur(function(){
            ...
            if(investTransferCardCardnum == null || investTransferCardCardnum == '' || investTransferCardCardnum == 0){
              $.alert('请输入用户银行卡号！');
              checkCardnum = 0;
              return false;
            }
            if(reInvestTransferCardCardnum == null || reInvestTransferCardCardnum == '' || reInvestTransferCardCardnum == 0){
              $.alert('请再次输入用户银行卡号！');
              checkCardnum = 0;
              return false;
            }
        ...
        function checkIMoney(){
            ...
            var str = "subjectId="+$('#subjectId').val()+"&investmentMoney="+investMoney+"&investmentActualInvestment="+investMoney;
            $.ajax({
                type:"post",
      ...
      //点击显示上一步输入框
       ...
       var addSubmitFlag =false //提交按钮的节流阀，true:可以点击 false:不可以点击
        ...
        function addSubmit(){ 
          ...
          //身份证复印件
          if('' != userPersonCardImgFile && userPersonCardImgFile.length > 0){
          ...
          //银行卡复印件
          if('' != userCardImgFile && userCardImgFile.length > 0){
          ...
          //风险测评材料
          if('' != userRiskTypeImgFile && userRiskTypeImgFile.length > 0){
