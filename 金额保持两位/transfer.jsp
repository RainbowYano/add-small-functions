...
<body>
    ...
    <script>
        ...
        function checkSubject(id) {
            ...
            otherSubjectHtml += '<div class="form-group"><label class="col-md-2 control-label ">标的余额：</label><div class="col-md-3"><p class="form-control-static"><span  id="leftAmount" class="" >'+  (lineData.subjectMoney-lineData.subjectAlreadyInvest).toFixed(2) +'</span></p></div></div>'
